...
module.exports = async client => {
  ...
  function getStreams(guild){
    ...
    tempData.channels.map(async function (chan, i) {
        ...
        let StreamData = await getStreamData(chan.ChannelName, process.env.twitch_clientID || config.twitch_clientID, process.env.authToken || config.authToken);
        ...
        const ChannelData = await getChannelData(chan.ChannelName, process.env.twitch_clientID || config.twitch_clientID, process.env.authToken || config.authToken)
