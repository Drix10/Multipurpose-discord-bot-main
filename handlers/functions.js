...
function ensure_economy_user(client, guildid, userid){
  client.economy.ensure(`${userid}`, {
    ...
    let data = client.economy.get(`${userid}`)
    ...
    if(data.black_market.boost.time !== 0 && (86400000 * 2) - (Date.now() - data.black_market.boost.time) <= 0)
    {
      ...
      client.economy.set(`${userid}`, 1, "black_market.boost.multiplier");
      client.economy.set(`${userid}`, 0, "black_market.boost.time");
    }  
